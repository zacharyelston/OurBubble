...
3. ✎ *Before we look:* if I give every line the same weight, will the ring be round?  *(and which way — along the cube's edges, or corner to corner through its middle? Ours, one per setting, are in the record from before the run; neither said which way, so this half is hers alone)*
