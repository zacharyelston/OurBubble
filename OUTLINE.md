...
2. If I scratch a mark where it ends, and another after lunch — what do I have?  *(two marks, each one where the shadow's edge fell: a number from the world, not from me — and lunch is a clock she already owns, no measuring required)*
