...
It is worth stopping on that, because it is the whole book in one move, and the move is smaller than
it looks. She has noticed that something changed. She could leave it there, and most of us do. Or she
could do one more ordinary thing: push a stick into the ground, scratch a mark where the shadow ends,
and come back in an hour to scratch another.
...
attached, and nothing more. What happens next is where everything is.
...
Nobody was waiting on him to prove himself. Measuring the Earth was a sideshow, and that is part of
why it makes a good first example: it did not take a genius, it did not take new mathematics, and it
took him one afternoon of arithmetic.

What he had was a story about a well. At Syene, far to the south, at noon on the longest day of the
year, sunlight was said to fall straight down a deep well and light the water at the bottom. Straight
down. Nothing shaded.
...
their shadows the same way by the same amount — so if one of them has no shadow, none of them do. The
ground between the two towns is therefore not flat. It curves.

Then comes the step that turns an observation into a measurement: he asked *how much* it curves. He
measured the angle of the Alexandria shadow, and it came out at about a fiftieth of a full turn. That
angle is the whole trick, because it is also the angle between the two towns seen from the centre of
the Earth. If a fiftieth of the circle separates them, the circle is fifty times the distance between
them.

He still needed that distance, and here the story is more ordinary than people expect. He did not
work it out. He used the bematists — professional pacers, men paid to walk between places and count
their steps, because pacing was how a kingdom knew its own size. Their figure for Alexandria to Syene
was around five thousand stadia.
...
We built a small world inside a computer, and it is smaller than you are probably picturing.

It has places to keep a number. It has lines joining each place to its neighbours. And it has one
rule, which says how a number changes when the numbers beside it change. That is all of it. The parts
fit on the back of an envelope, and that is usually where they start.

Then we asked the little world questions. Does a ripple spread out evenly in every direction, or does
it run faster along the lines? What does it cost to push a region of it around? Can a patch be
...
the little world: a patch we push on, measure, and hand back. Wherever the word appears, that patch is
what it names.

So: go back to the child and her two marks in the ground. She is one step away from Eratosthenes, and
it is not a large step. She has something that changed and a number for how much it changed. What she
