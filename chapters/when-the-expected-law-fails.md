...
This book has reported plenty of noes already. The wall did not change inertia. A volume could not be
emptied. And once, a pair of noes turned out to be ours rather than the lattice's, and was withdrawn.

This one is a different kind of no, and it is the kind that decides whether the others were worth
reading.

Every negative so far answered a *question* — can this be done? — and came back no, or came back no and
was later corrected. Here, for the first time, **the project proposed a law and its own instrument refused it.** We said what the number
...
There is a simple argument that gives you an answer. If you filled the *whole* cavity with the denser
material, the frequency would fall like a square root: quadruple the material weight and the frequency
...
The square-root argument assumes the material weight governs the whole resonating volume. Here it does
not. The lump occupies a small part of the cavity and most of the vibration is still sitting in
...
instrument, unchanged, refused the most natural material-scaling analogy anyone would have reached for.
