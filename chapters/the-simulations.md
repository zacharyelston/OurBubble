...
<a id="s-start-at-the-boundaries"></a>

## §01 · Boundaries — a primer, and no experiment

**The chapter.** [start-at-the-boundaries.md](start-at-the-boundaries.md)

**What this section carries.** No rung, no gate, no figure and no quoted number. The page is a primer — one scene from the author's own life, told in the first person, and the idea it left: that a puzzle is started at its border. Nothing in it is checkable against the record, and nothing in it needs to be; what it hands the reader is a habit, and the chapter after it is where the habit is put to work. It is listed here rather than left out so a reader can tell *no evidence was cited* from *no evidence exists*. The standards are what its one scope claim rests on.
...
<a id="s-where-the-inside-shows"></a>

## §02 · Where the inside shows — why we measure at an edge, and no experiment
...
## §03 · The shadow — the method, before any experiment
...
## §04 · A few thousand years of sharper shadows — the measurement history
...
<a id="s-staring-into-the-abyss"></a>

## §05 · Staring into the abyss — a primer, and no experiment

**The chapter.** [staring-into-the-abyss.md](staring-into-the-abyss.md)

**What this section carries.** No rung, no gate, no figure and no quoted number. The page is a primer — one scene from the author's own life, told in the first person, and the idea it left: that a written zero is where counting starts, and that it runs one way. The counting in it is counting, done on the page in front of the reader, and the zero is a mark on paper; the napkin chapters that follow compute their numbers while the book is built rather than quoting them. It is listed here rather than left out so a reader can tell *no evidence was cited* from *no evidence exists*. The standards are what its one scope claim rests on.
...
## §06 · Two dots, a line, and the first thing that closes — the object, from nothing
...
## §07 · One tetrahedron is a whole world — every kind of number, on a napkin
...
## §08 · Make it move — the one rule, and what one tick does
...
## §09 · The shape between — one tetrahedron, cut open
...
## §10 · Two worlds threaded — the last object that fits on a napkin, and the first that does not
...
## §11 · Room, and a world with no edge — why tetrahedra need a compromise
...
## §12 · Is it round? — the dial, set twice
...
## §13 · What does pushing on it cost? — the shaped push and its bill
...
## §14 · Can you wall a piece off? — one experiment, one yes and one no
...
## §15 · Can a gap be emptier than empty? — the one place the sign is real
...
## §16 · Can it tell me something I didn't tell it? — the answer key taken away
...
## §18 · Cast your own shadow — the reproduce path

**The chapter.** [cast-your-own-shadow.md](cast-your-own-shadow.md)

**Registered rungs.**

- lattice-constants 7.0 — the Container's random-walk return constant: how often a walker stepping at random along its lines comes home, reached by growing wrapped copies of the same dots and lines and reading off the number they were heading for, after the same machinery reproduced Watson's 1939 closed forms for two textbook lattices. Its gate re-runs in seconds
