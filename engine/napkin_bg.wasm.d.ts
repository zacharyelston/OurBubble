...
export const slosh_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
export const slosh_weighted_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
export const walk_json: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
