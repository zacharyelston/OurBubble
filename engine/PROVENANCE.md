...
| `napkin.js` | Generated glue for the pinned Rust engine. The additive experiment interface validates its bounded domain and returns named refusals; legacy entry points remain available. |
